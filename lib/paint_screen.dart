import 'dart:async';
import 'package:drawing_game/home_screen.dart';
import 'package:drawing_game/models/touch_points.dart';
import 'package:drawing_game/sidebar/player_scoreboard_drawer.dart';
import 'package:drawing_game/waiting_lobby_screen.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void renderTextBlank(String text) {
    ...
    print('room word is initially : ${text}');
  ...
  //this address is the local host ip, use ipconfig /all in cmd to find computers ip address and 
  //update this with the new address
  void connect() {
    _socket = IO.io('http://192.168.109.39:3000', <String, dynamic>{
    ...
    _socket.onConnect((data) {
      ...
      _socket.on('updateRoom', (roomData) {
        print('room word is : ${roomData['word']}');
        setState(() {
      ...
      body: dataOfRoom != null ? 
        ...
        children: [
          ...
          dataOfRoom['turn']['nickname'] != widget.data['nickname'] ? Align(
              ...
              SafeArea(child: IconButton(onPressed:()=>scaffoldKey.currentState!.openDrawer() , icon: Icon(Icons.menu, color: Colors.black,)))
        ],
      ) : FinalLeaderboard(scoreboard: scoreboard, winner: winner) 
      : WaitingLobbyScreen(lobbyName: dataOfRoom['name'], numberOfPlayers: dataOfRoom['players'].length, occupancy: dataOfRoom['occupancy'], players: dataOfRoom['players'],)
